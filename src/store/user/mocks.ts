...
export const mockNfts = [
  {
    ...
    commentsCount: 100,
    isLiked: true,
    nftName: 'NFT of my life',
    nftLink: 'https://google.com',
    assetLink: MockAsset1,
    walletId: 1,
    comments: [
      {
        authorName: 'boristheblade.near',
      ...
      {
        authorName: 'dkrasovskyi.testnet',
        authorId: 2,
        authorAvatar: EmptyAvatar,
        text: 'First Short comment',
  ...
  },
  {
    id: 2,
    userId: 2,
    userName: 'dkrasovskyi.testnet',
    userAvatar: EmptyAvatar,
    likesCount: 2233,
    commentsCount: 1001,
    isLiked: false,
    nftName: 'This is world',
    nftLink: 'https://google.com',
