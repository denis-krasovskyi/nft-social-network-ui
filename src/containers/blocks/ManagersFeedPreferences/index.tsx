...
import styles from './ManagersFeedPreferences.module.scss';

const ManagersFeedPreferences: React.FC<ManagersFeedPreferencesProps> = ({
  className,
  sorted,
  filtered,
  sortMenuList,
...
export enum MANAGERS_FEED_SORT_OPTIONS {
...
type ManagersFeedPreferencesProps = {
  className?: string;
  sorted?: boolean;
  filtered?: boolean;
  currentSortValue?: MANAGERS_FEED_SORT_OPTIONS;
  ...
  sortMenuList?: {
    value: MANAGERS_FEED_SORT_OPTIONS;
    label?: React.ReactNode;
    onClick?: (e: React.MouseEvent, closeMenuCb: () => void) => void;
  }[];
};

export default ManagersFeedPreferences;
